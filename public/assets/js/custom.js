...
/*function toggleCart() {
    ...
    if(width=="0"){
        ...
        document.getElementById("myCart").style.width = "22%";
    }
    else
    {
...
function onImageError(image) {
    image.onerror = "";
    image.src = IMAGES_PATH+"no_image.jpg";
    return true;
}
...
function incNumber1(){
    var c1 = parseInt(document.getElementById("NumberId").value);
    var maxQty = document.getElementById("NumberId").max;
    if(c1 != maxQty){
        c1++;
        document.getElementById("NumberId").value = c1;
        document.getElementById("NumberId").innerHTML = c1;
        calculateTotal();
    }
}
function decNumber1(){
...
function calculateTotal() {
    var price = parseFloat($('#priceElem').data('price'));
    var qty = parseInt($('#NumberId').val());
    var total = price * qty;
